...
export default class MenuView {
  ...
  create() {
    ...
    this.skill1Button.addOnInputDownClickListener(() => this.skill1Button.press());
    ...
    this.skill2Button.addOnInputDownClickListener(() => this.skill2Button.press());
    ...
    this.skill3Button.addOnInputDownClickListener(() => this.skill3Button.press());
    ...
    this.skill4Button.addOnInputDownClickListener(() => this.skill4Button.press());
    ...
    this.skill5Button.addOnInputOutClickListener(() => this.skill5Button.press());
